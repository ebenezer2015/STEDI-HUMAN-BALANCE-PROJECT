...
'''
CustomerFilter_node1739445212976 = sparkSqlQuery(glueContext, query = SqlQuery3732, mapping = {"myDataSource":accelerometer_trusted_node1739445043804, "myDataSource1":customer_trusted_node1739363051967}, transformation_ctx = "CustomerFilter_node1739445212976")
...
curated_customer_node1739363304581 = glueContext.write_dynamic_frame.from_options(frame=CustomerFilter_node1739445212976, connection_type="s3", format="json", connection_options={"path": "s3://stedi-lake-house-for-udacity-project/customer/curated/", "compression": "gzip", "partitionKeys": []}, transformation_ctx="curated_customer_node1739363304581")
